...
('P0006', 'Mehdi',   'Tazi',      'mehdi.tazi@demo.local',      'employee',   'Comptabilite', 'Tresorier',              'P0002', NULL,    '2020-11-03', NULL,         'active'),
...
('P0010', 'Rachid',  'Bennani',   'rachid.bennani@demo.local',  'contractor', 'IT',           'Consultant infra',       'P0003', NULL,    '2025-09-01', '2026-08-31', 'active'),
('P0011', 'Anouk',   'Lemaire',   'anouk.lemaire@demo.local',   'contractor', 'Commercial',   'Consultante CRM',        'P0004', NULL,    '2026-01-12', '2026-06-30', 'active'),
